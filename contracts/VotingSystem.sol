...
contract VotingSystem is ERC20, Ownable{
    ...
    function sendTokenForVoting(address _to) external onlyOwner {
         _mint(_to, 1);
    }
    ...
    function stopVoting(string memory _name) public{
        Voting storage newVoting = votings[_name];
    ...
    function all0ption(string memory _name) public view returns(string[] memory){
